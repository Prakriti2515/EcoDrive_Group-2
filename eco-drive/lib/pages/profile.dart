...
import 'user_provider.dart'; // Make sure to import your user provider
      ...
      child: WillPopScope(
        onWillPop: () async {
          ...
          Navigator.pushAndRemoveUntil(
            ...
            MaterialPageRoute(
                builder: (context) =>
                    Homepage()), // Ensure correct homepage import
            ...
            children: [
              ...
              ListTile(
                ...
                title: Consumer<UserProvider>(
                  // Use Consumer to get the username
                  builder: (context, userProvider, child) {
                    return Text(
                      userProvider
                          .username, // Display the username from the provider
                      style:
                          ...
                          Navigator.push(
                            ...
                            MaterialPageRoute(
                                builder: (context) => MyProfile(
                                      username:
                                          '', // You may pass the username here if needed
                                      email:
                                          '', // Pass email as well if required
                                    )),
                          );
                        },
                      ),
